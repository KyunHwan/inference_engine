...
from env_actor.auto.inference_algorithms.rtc_local.data_manager.utils.shared_memory_utils import ShmArraySpec
...
class SharedMemoryInterface:
    def __init__(self, 
        ...
        if robot == "igris_b":
            from env_actor.auto.inference_algorithms.rtc_local.data_manager.robots.igris_b.shm_manager_bridge import SharedMemoryManager
        elif robot == "igris_c":
            from env_actor.auto.inference_algorithms.rtc_local.data_manager.robots.igris_c.shm_manager_bridge import SharedMemoryManager
